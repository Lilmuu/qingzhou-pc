...
// 编辑 邮件分组
export function businessUpdateGroupName(query) {
  return request({
    url: `${base}/mail/business/updateGroupName`,
    method: 'get',
    params: query
  })
}
...
// 查询某个邮箱未读数量
export function mailUnreadCount(id) {
  return request({
    url: `${base}/mail/business/updateMailStatus?id=${id}`,
    method: 'get',
  })
}
...
//查询邮箱人员信息
export function configSelectUserInfoByEmail(query) {
  return request({
    url: `${base}/mail/business/selectUserInfoByEmail`,
    method: 'post',
    params: query
  })
}

export function businessCheckMailConfig(query) {
  return request({
    url: `${base}/mail/business/checkMailConfig`,
    method: 'get',
    params: query
  })
}